...
Sub DataCleanup()
    ...
    PopulateChart dataWs, ws1, 23, "Supplier Anomaly Count Per Disposition", suppliers(1), lastRow
...
End Function
Sub PopulateChart(dataWs As Worksheet, analysisWs As Worksheet, countCol As Long, chartTitle As String, selSup As String, lastRow As Long, Optional groupBy5 As Boolean = False)
    Dim i As Long
    Dim r As Long
    Dim n As Long
    Dim nRows As Long
...
Sub RefreshSheet1()
    ...
    lastRow = dataWs.Cells(dataWs.Rows.Count, "A").End(xlUp).Row
    PopulateChart dataWs, aws, 23, "Supplier Anomaly Count Per Disposition", selSup, lastRow
End Sub
Sub RefreshSheet2()
    Dim dataWs As Worksheet
    Dim aws As Worksheet
