...
Sub DataCleanup()
    ...
    PopulateChart dataWs, ws1, 25, "Supplier Anomaly Count Per Disposition", suppliers(1), lastRow
...
Sub RefreshSheet1()
    ...
    lastRow = dataWs.Cells(dataWs.Rows.Count, "A").End(xlUp).Row
    PopulateChart dataWs, aws, 25, "Supplier Anomaly Count Per Disposition", selSup, lastRow
End Sub
Sub RefreshSheet2()
    Dim dataWs As Worksheet
    Dim aws As Worksheet
